...
public class TipoDocumento implements Serializable {
	...
	public TipoDocumento(String descricao, String mascara) {
		this.descricao = descricao;
		this.mascara = mascara;
	}
	
	public TipoDocumento(Long id, String descricao, String mascara) {
		this.id = id;
		this.descricao = descricao;
		this.mascara = mascara;
	}
	...
	public String toString() {
		return "TipoDocumento [id=" + id + ", descricao=" + descricao + ", mascara=" + mascara + "]";
	}
